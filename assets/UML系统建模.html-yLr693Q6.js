import{_ as n,c as a,a as e,o as l}from"./app-DvDtyGnb.js";const i={};function p(t,s){return l(),a("div",null,s[0]||(s[0]=[e(`<h1 id="uml-系统建模" tabindex="-1"><a class="header-anchor" href="#uml-系统建模"><span>UML 系统建模</span></a></h1><hr><h2 id="一、用例图-核心业务流程建模" tabindex="-1"><a class="header-anchor" href="#一、用例图-核心业务流程建模"><span>一、用例图（核心业务流程建模）</span></a></h2><h3 id="_1-主要用例覆盖" tabindex="-1"><a class="header-anchor" href="#_1-主要用例覆盖"><span>1. 主要用例覆盖</span></a></h3><ul><li>车辆管理</li><li>用户注册/绑定</li><li>充电服务</li><li>历史数据分析</li><li>消息通知与告警</li><li>后台管理与权限控制</li></ul><h3 id="_2-用例图-plantuml-示例" tabindex="-1"><a class="header-anchor" href="#_2-用例图-plantuml-示例"><span>2. 用例图（PlantUML 示例）</span></a></h3><div class="language-plantuml line-numbers-mode" data-highlighter="prismjs" data-ext="plantuml"><pre><code class="language-plantuml"><span class="line"><span class="token delimiter punctuation">@startuml</span></span>
